#1、wget https://developer.download.nvidia.com/devblogs/speeding-up-unet.7z
#2、tar xvf speeding-up-unet.7z
#3、cd unet
#4、python create_network.py #Inside the unet folder, it creates the unet.onnx file
